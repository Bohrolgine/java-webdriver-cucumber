...
public class QuoteForm extends Page {
    ...
    public boolean getErrorFieldDisplayed(String fieldName){
    ...
    public String getagreedToPrivacyPolicyErrorText() {
        return policyError.getText();
    }
    ...
    public void fillContactInfo(String nameValue, String phoneValue) {
        ...
        contactPersonPhone.sendKeys(phoneValue); //or:
        //sendKeys(contactPersonName, nameValue);
        //sendKeys(contactPersonPhone, phoneValue);
